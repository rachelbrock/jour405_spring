...
As a whole, the model has statistical significance according to the F-statistic of 15.44 with a very low p-value. Although the is not perfect (the Residual Standard Error is relatively high) it could still be useful for the analysis and reporting of our data. 
...
Points scored has the greatest impact on wins. This makes realistic sense, because the more points a team scores the more likely they are to have the most points and win the game. Yards Gained seem to have the least impact. It is similar and has the same impact basically as points scored because you have to gain yards to score points. 
...
There are a variety of factors that impact how much a team wins and all of them contribute to whether a team comes out on top. This model shows which factors most influence if a team will end up winning. 
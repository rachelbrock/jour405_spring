...
Less than 5 calls and more than 15 calls would be considered unusual. I see a pattern of around 10 calls per day.
...
Let's visualize these unusual days in the context of the full dataset. How do they differ from your answer on Task 3?
 ...
 I said 15 and 5 in my prediction above, and this is similar to what I see in this data. The majority of the data falls close to the mean, but there are more above the median calls than below 
...
Saturdays often have a greater amount of 911 calls than other days of the week, according to data from Baltimore City Police. 
...
One potential angle would be to explore if the 911 overall deaths were connected to some lethal batch of drugs that showed up on the streets. This could be followed up by speaking to families who have experienced loss from overdose. This could into an entire investigative report that examines where the calls are coming from and if they are concentrated to a certain area.
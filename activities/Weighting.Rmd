...
0.23 means a lot of responses are representative of their population but 3.04 means they are one of only a few responses of their population
3. Why might some respondents be weighted more heavily than others?
some responses are weighted more heavily because their were not many resposes from that population 
...
The rarely/never category shows the biggest difference in weighted/ unweighted results

2. How might these differences affect reporting on likely voter turnout?
It means people who are rarely/never voters change their minds more often so their turnout 
...
These differences exist because never/ rarely voters are less likely to answer surveys and are under represented in the sample. Always voters are more predictable and vocal in surveys.  
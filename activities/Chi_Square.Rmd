...
The latter set is slightly different than expected, but overall it is pretty similar. The biggest difference is in the 5 star that was expected to be higher.
...
We would reject the null hypothesis that the observed frequencies are consistent with the expected percentages. There is a large enough difference between the observed an expected that we can ensure that it is not a coincidence that they are different. The 5 stars and 2 stars were both significantly different proportionally, especially the 2 stars. Although the two sets looked similar initially, they were significantly different as proven by the Chi-Square test.

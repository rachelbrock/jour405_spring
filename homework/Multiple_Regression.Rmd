...
Income and median age both have a positive relationship with voter turnout. As those variables get higher, so does the voter turnout. These two variables also seem to be closely correlated with one another, with a similar slope line on their graphs. On the scatter plots income and education have relatively strong linear relationship with voter turnout, but population does not.  
...
This model is able to predict voter turnout quite well, with income and education seeming to be the most important factors. The factors that are not as significant are percent unemployed and median age. This model is useful from what I have seen but insignifact factors could be removed for greater clarity.
...
Model 1 (Full model) - Adjusted R-squared: 0.8022713 
Model 2 - Adjusted R-squared: 0.1656268  removing income
Model 3 - Adjusted R-squared: 0.2111296  removing median_age
Model 4 - Adjusted R-squared: 0.05044749 removing education

Here I have shown that when you take away the two most vital factors, income and education, the R value goes down significantly. None of these models would be considered good but the next highest would be median age. 
...
When you are looking into voter participation in a certain community you can analyze the data about that community to make an educated guess about voter turnout. You can go into the community knowing that you may find more or less people who vote and ask them more insightful and tailored questions about their experience with politics. For example, some poorer communities with less access to education, as the data shows us, may not be up to date on political information. So you cannot go in speaking in political jargon like you would speak to people in Washington. 

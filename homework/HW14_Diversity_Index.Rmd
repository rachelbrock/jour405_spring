...
The cities that initially stand out to me as diverse are: Baltimore City, Columbia, and Silver Spring. All of these places have large populations, but they also have a variety of people that are of different races.
...
The place with the highest race probability is Summerfield, MD. This is because out of the 12,403 people that live there, 11,565 people are Black. This place has a smaller population than most other parts of Maryland, but it also is a large majority Black so it has a higher race probability.
...
The places with the lowest Hisp_Prob scores (ex. Chillum, East Riverdale, Wheaton) also have low race probability scores. This leads to the idea that people who identify as Hispanic tend to live in communities with more diversity. 
...
Highest Index Scores: Langley Park, Wheaton, Adelphi all of these places are suburban and close to DC
Lowest Index Scores: Largo, Lake Arbor, Lake Shore suburban and also close to DC (besides Lake Shore that is in Pasadena)
...
Despite their close proximity, Prince George's county neighborhoods have large diversity divides. Langley Park and Adelphi are located next to each other and have some of the most diverse neighborhoods in all of Maryland, according to the Diversity Index. But, only a few neighborhoods away, are Largo and Lake Arbor, which have the least diversity in all of Maryland, according to the Diversity Index. 

If I were reporting this story I would go into the neighborhoods to gather more information on local residents, maybe exlore some local businesses, and get a feel for the communities. 
...
md_cities |> mutate(property_rate_2019 = property2019/pop2019 * 10000)
md_cities |> mutate(violent_rate_2020 = violent2020/pop2020 * 10000)
md_cities |> mutate(property_rate_2020 = property2020/pop2020 * 10000)
...
```{r}
md_cities_change <- md_cities |> mutate(pct_change = (property2020 - property2019)/property2020*100)
  md_cities |> mutate(pct_change = (violent2020 - violent2019)/violent2020*100)
...
### Task 10: Percentiles
```{r}
md_cities_percentiles <- md_cities |> mutate(percentile = ntile ((violent_rate_2020 = violent2020/pop2020 * 10000), 100))

summary(IQR=IQR(violent_rate_2020))

This new data makes me realize Kitzmiller has few violent crimes yet it is in one of the highest percentiles. 
```

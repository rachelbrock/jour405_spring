...
Just looking at the dataframe, I would say that test scores have not improved. There are only 3 scores (78,77,79) that are more than then previous average of 76.2. Without even doing any calculations, I would venture to say that the average will be very similar to before. 
...
Looking at the mean of test scores I can see that they did not improve, in fact, the average score decreased. It is interesting that the standard deviation also increased: meaning that students have a smaller range of scores than they did before. It makes me wonder if the program is actually hurting students.
...
Reading scores remain consistent, despite new program implementation.
...
**Hypotheses:**
Null: The new reading program is improving third-grade reading scores across the school district
Alternative: The new reading program is not improving third-grade reading scores across the school district
...
The p-value tells us that our null hypothesis is unlikely to be true because it is greater than 0.05. This does not mean that the reading program has had a negative impact on students, but it has not had a significantly positive one. The p-value is not perfectly representative of the data because it can quicly change based on the included factors, so we cannot say the impact of the reading program is negative or positive.
...
Reading scores have remained generally consistent, even with the implementation of a new reading program. There is not data to support the superintendent's claim.

### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?
Reading levels (what level of complexity are the books the student can read) and/ or reading comprehension tests (do they understand the meaning behind the words in the page)

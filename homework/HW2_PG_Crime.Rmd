...
Car accidents have increased every month of this year. Every type of robbery has trended down over the months-maybe there was a new safety measure implemented. 
...
average_incidents <-total_incidents |> mutate(average= (total_incidents/12))
...
```{r}
june_change <- pg_crime_averages |> mutate(pct_change = (june_average 
```

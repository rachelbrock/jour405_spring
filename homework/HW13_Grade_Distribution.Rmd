...
The difference in the expected frequency of 80 and observed frequency of 100 for grade A's is meaningful because it is a substantial difference. This is also true for the expected grade for C's, which was 120 versus the observed which was 100. 
...
In this case, we would reject the null hypothesis that the observed frequencies are consistent with the expected percentages. There is a large enough difference between the observed an expected that we can ensure that it is not a coincidence that they are different.
...
The most notable discrepancies are in the A's and C's sections. It was expected that more people would get C's and less people would get A's than the observed data showed. This makes me question if there were any recent programs put into place recently that helped students feel more academically supported than before. Because it was expected that they would be doing worse I wonder if they are doing better for a specific reason.